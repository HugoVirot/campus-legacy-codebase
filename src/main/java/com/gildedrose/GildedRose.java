...
//**************************************cas du concert****************************************************
                ...
                if (items[i].quality < 50) {            // dans tous les cas : +1
                    items[i].quality += 1;
                    if (items[i].sellIn < 11 && items[i].quality < 50) {         // concert avec 10 jours ou moins restants
                        items[i].quality += 1;
                    }
                    if (items[i].sellIn < 6 && items[i].quality < 50) {          // concert avec 5 jours ou moins (rentre dans les deux cas : deux fois +1)
                        items[i].quality += 1;
                    }
                }
